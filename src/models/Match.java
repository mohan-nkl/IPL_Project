...
public class Match {
    ...
    public Match(int matchId, int season, String city, String date, String team1, String team2,
                 String tossWinner, String tossDecision, String result, int dlApplied, String winner,
                 int winByRuns, int winByWickets, String playerOfMatch, String venue, String umpire1,
